...
%% Generated: 2026-02-18 19:11:42
%% Include in article with: \input{HalogenGroups_telomer_validation.tex}
%%

\subsection*{Fluorotelomer Detection Validation}

Fluorotelomer compounds represent a critical class of PFAS that contain telomer chains (perfluoroalkyl segments connected to non-fluorinated moieties via linking groups). To validate HalogenGroups' ability to detect these important compounds, we conducted a comprehensive benchmark using 785 fluorotelomer structures from the PubChem database.
...
\midrule
98 & Telomer methyl & 589 & 34.7\% \\
87 & Telomer sulfure & 184 & 10.8\% \\
109 & Telomer sulfone & 139 & 8.2\% \\
94 & Telomer trimethylamine & 83 & 4.9\% \\
108 & Telomer sulfinyl & 68 & 4.0\% \\
103 & Telomer glycine & 65 & 3.8\% \\
88 & Telomer sulfonamide & 61 & 3.6\% \\
95 & Telomer sulfinic acid & 61 & 3.6\% \\
96 & Telomer sulfenic acid & 61 & 3.6\% \\
80 & Telomer sulfonic acid & 57 & 3.4\% \\
90 & Telomer betaine & 36 & 2.1\% \\
86 & Telomer alcohol & 33 & 1.9\% \\
82 & Telomer diphosphate & 28 & 1.6\% \\
78 & Telomer carboxylic acids & 25 & 1.5\% \\
110 & Telomer acetylsulfanylhydroxypropanoic acid & 24 & 1.4\% \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{enumerate}
\item \textbf{High Detection Accuracy:} HalogenGroups successfully identified 93.5\% of fluorotelomer compounds from a diverse PubChem-derived dataset, validating the algorithm's capability to recognize telomer structural patterns.
