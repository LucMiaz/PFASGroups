...
\midrule
Enhanced Functional Groups & 3,400 & Generated & Systematically generated molecules covering all 55 PFAS functional groups \\
...
\midrule
PFASgroups & 200 & 62.33 & 37.93 & 63.10 & 7.27 & 312.53 \\
PFAS-Atlas & 200 & 51.94 & 47.51 & 11.54 & 36.89 & 92.27 \\
\midrule
\multicolumn{7}{l}{\textit{Speedup factor (Atlas/PFASgroups): 0.83$\times$}} \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
0--20 & 24 & 8.87 & 1.07 & 38.48 & 1.09 \\
20--40 & 44 & 15.73 & 2.63 & 41.15 & 1.21 \\
40--60 & 27 & 27.19 & 3.75 & 44.58 & 1.11 \\
60--80 & 28 & 44.77 & 5.68 & 50.83 & 3.43 \\
80--100 & 18 & 64.14 & 6.93 & 61.14 & 2.00 \\
100--150 & 53 & 131.59 & 50.57 & 65.79 & 2.39 \\
150--200 & 6 & 240.87 & 33.50 & 73.13 & 8.66 \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
Alcohols & 2 & 70 & 100.0 & 11.87 & 0.0 \\
Aromatics & 4 & 3400 & 100.0 & 19.38 & 0.0 \\
Carboxylic Acids & 5 & 118 & 100.0 & 14.20 & 0.0 \\
Cyclic & 2 & 40 & 100.0 & 7.39 & 0.0 \\
Ethers & 2 & 40 & 100.0 & 9.12 & 0.0 \\
Hydrocarbons & 5 & 160 & 100.0 & 9.85 & 0.0 \\
Other & 26 & 1514 & 100.0 & 17.81 & 0.0 \\
Phosphonic Acids & 2 & 80 & 100.0 & 11.64 & 0.0 \\
Sulfonic Acids & 5 & 80 & 100.0 & 18.77 & 0.0 \\
\bottomrule
\end{tabular}
\end{table}
...
Mean Exec. Time (ms) & 62.33 & 51.94 & -- & PFAS-Atlas \\
Speedup Factor & -- & -- & -- & 0.83$\times$ \\
...
\caption{Exponential scaling of execution time with molecule size. Points represent individual molecules, solid line shows fitted model $t(n) = a \cdot e^{\alpha \cdot n}$, and dashed lines indicate 95\% confidence interval. Model parameters: $a = 0.007716$ s, $\alpha = 0.022843$ atoms$^{-1}$, $R^2 = 0.9815$.}
...
\item \textbf{Performance Scaling:} Execution time follows an exponential model ($R^2 = 0.9815$) with mean processing time of 62.33 ms per molecule and median of 37.93 ms.

\item \textbf{Comparative Performance:} Performance comparable to PFAS-Atlas (ratio: 0.83$\times$) while providing detailed functional group identification.
