...
\midrule
Enhanced Functional Groups & 3,880 & Generated & Systematically generated molecules covering all 55 PFAS functional groups \\
...
\midrule
\rowcolor[HTML]{FAEADE}HalogenGroups & 2,500 & 205.09 & 28.65 & 426.00 & 3.95 & 3324.46 \\
\rowcolor[HTML]{D6E4F5}PFAS-Atlas & 2,500 & 66.97 & 38.45 & 82.96 & 0.16 & 601.62 \\
\midrule
\multicolumn{7}{l}{\textit{Speedup factor (Atlas/HalogenGroups): 0.33$\times$}} \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
\rowcolor[HTML]{FAEADE}0--20 & 989 & 13.02 & 4.66 & 36.93 & 5.04 \\
20--40 & 233 & 23.28 & 12.26 & 38.18 & 15.01 \\
\rowcolor[HTML]{FAEADE}40--60 & 90 & 27.36 & 9.23 & 29.28 & 25.51 \\
60--80 & 101 & 39.32 & 13.26 & 41.74 & 27.71 \\
\rowcolor[HTML]{FAEADE}80--100 & 104 & 54.85 & 15.07 & 48.49 & 31.14 \\
100--150 & 237 & 82.05 & 30.45 & 47.26 & 41.51 \\
\rowcolor[HTML]{FAEADE}150--200 & 155 & 134.44 & 44.91 & 73.16 & 56.08 \\
200--500 & 466 & 493.75 & 338.25 & 120.54 & 106.32 \\
\bottomrule
\end{tabular}
\end{table}
...
Mean Exec. Time (ms) & 205.09 & 66.97 & -- & PFAS-Atlas \\
\rowcolor[HTML]{F5F5F5}Speedup Factor & -- & -- & -- & 0.33$\times$ \\
...
\caption{Exponential scaling of execution time with molecule size. Points represent individual molecules, solid line shows fitted model $t(n) = a \cdot e^{\alpha \cdot n}$, and dashed lines indicate 95\% confidence interval. Model parameters: $a = 0.014745$ s, $\alpha = 0.009497$ atoms$^{-1}$, $R^2 = 0.9030$.}
...
\item \textbf{PFAS Definitions Benchmark:} Comparison of five PFAS definition systems shows accuracy ranging from 0.0\% to 0.0\% across OECD, EU, OPPT, UK, and PFASSTRUCTv5 definitions.

\item \textbf{Performance Scaling:} Execution time follows an exponential model ($R^2 = 0.9030$) with mean processing time of 205.09 ms per molecule and median of 28.65 ms.

\item \textbf{Comparative Performance:} Performance comparable to PFAS-Atlas (ratio: 0.33$\times$) while providing detailed functional group identification.
