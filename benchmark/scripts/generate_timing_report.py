...
def generate_html_report(output_file='reports/benchmark_timing_report.html'):
...
if __name__ == '__main__':
    import sys
    output_file = sys.argv[1] if len(sys.argv) > 1 else 'reports/benchmark_timing_report.html'
